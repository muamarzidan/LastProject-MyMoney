export default function UpdateTransactionOutcomePage() {
  return (
    <div className="flex items-center justify-center h-screen">
      <h1 className="text-2xl font-bold">Update Transaction Outcome Page</h1>
    </div>
  );
}
...
//   return (
//     <>
//       <ComponentCard title="Update Transaksi" className="">
